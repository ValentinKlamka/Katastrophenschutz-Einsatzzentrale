...
def logistik_agent_aufbauen():
    ...
    return create_agent(
        ...
        system_prompt=(
            ...
            "3. Plane Transporte mit transport_einplanen() – TRIAGE-REGELN BEACHTEN:\n"
            "   - SCHWARZ: KEIN Transport einplanen (verstorben/aussichtslos)\n"
            "   - ROT → Klinikum_Stadtmitte oder Uniklinik_Zentrum (Traumatologie/Verbrennungsmedizin)\n"
